...
nSims = 3
tp.MC <- getTrans.MC(nSims,tList,.02,.008,.015,10)
tp.FM <- getTrans.FreqMon(tList, .02,.008,.015,10)
@
...
FFT.rep = 2  #number of repetitions
...
plot(tList, eventsFFT[1,], pch = 1, col = 2, ylim = c(0,7.1), 
     ylab = "Expectation", xlab = "Observation Interval Length", main = "Expected Births")
...
plot(tList, eventsFFT[2,], pch = 1, col = 2,ylim = c(0,1.7), 
     ylab = "Expectation", xlab = "Observation Interval Length", main = "Expected Shifts")
...
plot(tList, eventsFFT[3,], pch = 1, col = 2, ylim = c(0,5.1), 
     ylab = "Expectation", xlab = "Observation Interval Length", main = "Expected Deaths")
...
plot(tList, eventsFFT[4,], pch = 1, col = 2, ylim = c(0,65), 
     ylab = "Expectation", xlab = "Observation Interval Length", main = "Expected Particle Time")
...
<<>>=
t.pat <- .2
#apply(patients.rates,1,mean) #this line displays the average lam, v, mu given the fake patients
...
relTol = .0000001 #relative convergence criteria
